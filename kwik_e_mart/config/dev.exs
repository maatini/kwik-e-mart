...
config :kwik_e_mart, KwikEMartWeb.Endpoint,
  ...
  secret_key_base: secret_key_base,
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:kwik_e_mart, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:kwik_e_mart, ~w(--watch)]}
  ]
...
config :kwik_e_mart, KwikEMartWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/kwik_e_mart_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :kwik_e_mart, dev_routes: true
