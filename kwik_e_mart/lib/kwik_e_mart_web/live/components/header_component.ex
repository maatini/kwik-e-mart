      ...
      <div class="kem-nav-inner">
        <div class="flex items-center gap-8">
          ...
          <nav class="hidden md:flex items-center gap-6">
            <.link navigate="/angebote/live" class={nav_link_class(@nav_active, :angebote)}>
              Angebote
            </.link>
            <.link navigate="/rezepte/live" class={nav_link_class(@nav_active, :rezepte)}>
              Rezepte
            </.link>
            <.link navigate="/markt-waehlen" class={nav_link_class(@nav_active, :markt)}>
              Märkte
            </.link>
