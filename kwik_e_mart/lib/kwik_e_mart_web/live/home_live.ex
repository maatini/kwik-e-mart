defmodule KwikEMartWeb.HomeLive do
  ...
  def render(assigns) do
      ...
      <div class="kem-carousel-track">
        ...
        <div class="kem-carousel-slide bg-kem-yellow">
          <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 flex items-center justify-between w-full h-full">
            <div class="max-w-xl">
              <p class="text-kem-green font-black text-sm uppercase tracking-widest mb-2">🍺 Sommer-Special</p>
        ...
        <div class="kem-carousel-slide bg-kem-green">
          <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 flex items-center justify-between w-full h-full">
            <div class="max-w-xl">
              <p class="text-kem-yellow font-black text-sm uppercase tracking-widest mb-2">⭐ Unsere Marken</p>
        ...
        <div class="kem-carousel-slide bg-kem-dark">
          <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 flex items-center justify-between w-full h-full">
            <div class="max-w-xl">
              <p class="text-kem-yellow font-black text-sm uppercase tracking-widest mb-2">🍛 Neue Rezepte</p>
              <h1 class="text-4xl lg:text-6xl font-black text-white leading-tight mb-4">
                Kochen wie Apu –<br/>
    ...
    <div class="kem-brand-strip">
      <div class="kem-section-inner">
        <p class="text-center text-sm font-bold text-gray-500 uppercase tracking-widest mb-6">Unsere Eigenmarken</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <.link navigate={~p"/angebote/live"} class="kem-service-item">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">Jeden Sonntag neue Deals – pünktlich um 03:00 Uhr Springfield-Zeit.</p>
            </div>
          </.link>
          <.link navigate={~p"/rezepte/live"} class="kem-service-item">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">Von Apu persönlich kuratiert. Indisch, amerikanisch, vegetarisch.</p>
            </div>
          </.link>
          <.link navigate={~p"/markt-waehlen"} class="kem-service-item">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">PLZ, Stadt oder Geolocation – wir finden deinen nächsten Kwik-E-Mart.</p>
            </div>
          </.link>
        </div>
      </div>
    ...
    <div class="kem-app-banner">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
        <div class="text-white max-w-lg">
          <p class="text-kem-yellow font-black text-sm uppercase tracking-widest mb-2">📱 Springfield Mobile</p>
    ...
    <section class="kem-newsletter-section">
      <div class="kem-section-inner text-center">
        ...
        <% else %>
          <form phx-submit="subscribe_newsletter" class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              name="email"
