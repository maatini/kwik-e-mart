defmodule KwikEMartWeb.OffersLive do
  ...
  def handle_params(%{"superknueller" => "true"}, _uri, socket) do
    ...
    {:noreply,
     assign(socket,
       offers: offers,
       date_range: valid_range(offers),
       selected_category: nil,
       superknueller_only: true
     )}
  end
      ...
      {cat_id_int, ""} ->
        ...
        {:noreply,
         assign(socket,
           offers: offers,
           date_range: valid_range(offers),
           selected_category: cat_id_int,
           superknueller_only: false
         )}
    ...
    <div class="kem-page-header">
      <div class="kem-page-header-inner">
        ...
        <div class="flex items-center gap-3">
          ...
          <%= if @current_market do %>
            <a
              href={~p"/markt-waehlen"}
              class="flex items-center gap-2 text-sm font-medium text-kem-green hover:underline"
            >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
          <button
            ...
            class={
              if(!@selected_category && !@superknueller_only,
              ...
              <div class="offer-card-image">
                ...
                <%= if Date.diff(offer.valid_to, @today) <= 3 do %>
                  <div class="offer-countdown-badge">
                    Noch {Date.diff(offer.valid_to, @today)} Tag{if Date.diff(offer.valid_to, @today) !=
                                                                      1,
                                                                    do: "e"}
                  </div>
                <% end %>
      ...
      <% else %>
        <div class="text-center py-20">
          ...
          <p class="text-gray-500 mb-6">
            Wähle einen anderen Filter oder such dir einen Markt in deiner Nähe.
          </p>
