  ...
  def render(assigns) do
    ...
    <div class="bg-white border-b border-gray-100">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <.link navigate={~p"/rezepte/live"} class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-kem-green transition-colors">
          ← Alle Rezepte
        </.link>
      </div>
    </div>
    ...
    <div class="bg-gray-50 py-10">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1">
              <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                ...
                <div class="mt-5 pt-4 border-t border-gray-100">
                  <.link navigate={~p"/angebote/live"} class="text-sm text-kem-green font-semibold hover:underline">
          ...
          <%!-- Instructions --%>
          <div class={if(@recipe.ingredients && @recipe.ingredients != [], do: "md:col-span-2", else: "md:col-span-3")}>
