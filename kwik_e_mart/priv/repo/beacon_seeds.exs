    ...
    <footer class="bg-[#1a1a1a] text-gray-300 mt-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <p class="text-xs leading-relaxed">Springfield's einziger<br/>24/7 Nahversorger seit 1989.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p class="text-sm">Täglich<br/><span class="text-[#FFED00] font-bold">0:00 – 24:00 Uhr</span></p>
        </div>
      </div>
...
layout =
  case Content.list_layouts(:edeka) |> Enum.find(&(&1.title == "Kwik-E-Mart Standard")) do
    %Content.Layout{} = existing ->
      IO.puts("⏭  Layout bereits vorhanden: #{existing.id}")
      existing
...
<section class="relative overflow-hidden bg-[#FFED00]">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 flex flex-col lg:flex-row items-center gap-10">
    ...
    <div class="flex-shrink-0 w-72 h-72 lg:w-96 lg:h-96">
...
<section class="py-16 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
      <div class="bg-gradient-to-b from-[#FFED00]/20 to-white rounded-2xl p-6 text-center border-2 border-transparent hover:border-[#FFED00] transition-all shadow-sm hover:shadow-md">
        <div class="text-6xl mb-3">🥤</div>
        <h3 class="font-bold text-lg">Squishee</h3>
        <p class="text-sm text-gray-500 mt-1">Der Original Slush in 12 Geschmacksrichtungen</p>
        <p class="mt-3 text-[#00A651] font-black text-xl">ab 0,99 €</p>
      </div>
      <div class="bg-gradient-to-b from-[#E3001B]/10 to-white rounded-2xl p-6 text-center border-2 border-transparent hover:border-[#E3001B] transition-all shadow-sm hover:shadow-md">
        <div class="text-6xl mb-3">🥣</div>
      ...
      <div class="bg-gradient-to-b from-[#00A651]/10 to-white rounded-2xl p-6 text-center border-2 border-transparent hover:border-[#00A651] transition-all shadow-sm hover:shadow-md">
        <div class="text-6xl mb-3">🍺</div>
      ...
      <div class="bg-gradient-to-b from-orange-100 to-white rounded-2xl p-6 text-center border-2 border-transparent hover:border-orange-300 transition-all shadow-sm hover:shadow-md">
        <div class="text-6xl mb-3">🌭</div>
...
<section class="py-16 bg-gray-50">
  <div class="max-w-3xl mx-auto px-4 text-center">
    ...
    <blockquote class="text-2xl font-black text-[#1a1a1a] leading-tight mb-4">
      „Ich bin hergekommen als einfacher Immigrant mit einem Doktortitel in Ingenieurswesen.
      Und jetzt leite ich einen der begehrtesten Convenience Stores in ganz Springfield."
    </blockquote>
...
<section class="py-16 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-end justify-between mb-8">
      ...
      <a href="/rezepte/live" class="hidden md:block text-[#00A651] font-semibold hover:underline">Alle Rezepte →</a>
    </div>
...
page =
  case Content.get_page_by(:edeka, path: "/") do
    %Content.Page{} = existing ->
      IO.puts("⏭  Seite bereits vorhanden: #{existing.id}")
      existing
